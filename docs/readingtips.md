...
- [EnglishClub Grammar](https://www.englishclub.com/grammar/)
...
Tại sao lại vậy? Bởi vì bạn không chỉ học một nghĩa đơn lẻ – bạn đang học cách tư duy của từ đó trong ngữ cảnh, và điều này khó có thể truyền tải đầy đủ qua bản dịch (Đọc thêm [Hướng dẫn đơn ngữ](monolingual.md) để bắt đầu chuyển qua sử dụng từ điển đơn ngữ).
...
!!! info "Bạn tính lấy ví dụ là: Apple nghĩa là quả táo thì sai thế nào được đúng không =)))"
    ...
    ![Ảnh quả chanh ở Việt Nam](img/chanh-vi.png)
...
Cảm ơn [bài viết của shoui](http://learnjapanese.moe/readingtips/) (TheMoeWay) vì ý tưởng này.